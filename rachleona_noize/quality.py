...
def antifake_quality_func(perturber):
    xs = []
    ys = []
    ...
    def f(new_tensor, perturbation):
        ...
        # aggregate loss 
        return perturber.SNR_WEIGHT * quality_snr - perturber.PERTURBATION_NORM_WEIGHT * quality_l2_norm - perturber.FREQUENCY_WEIGHT * quality_frequency
